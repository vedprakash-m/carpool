...
interface MakeupOptionsListProps {
  ...
  onDelete: (proposalId: string) => Promise<{ success: boolean; error?: string }>;
}

export function MakeupOptionsList({ makeupOptions, onDelete }: MakeupOptionsListProps) {
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Create a proposal to schedule makeup trips for your travel periods.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded border ${getStatusColor(option.status)}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Trips to Makeup</p>
                      <p className="text-sm text-gray-600">
                        {option.tripsToMakeup} trip{option.tripsToMakeup !== 1 ? 's' : ''}
                      </p>
                    </div>
                  </div>
                  ...
                  {option.adminNotes && (
                    <div className="mb-3">
                      ...
                      <p className="text-sm text-gray-600">{option.adminNotes}</p>
                    </div>
                  )}
