        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              {todayAssignments.map((assignment, index) => (<div key={index} className={`p-4 rounded-lg shadow-sm border-l-4 ${assignment.isDriving
                ...
                : "You're a passenger"}
                    ...
                    {assignment.isDriving ? (<div className="flex space-x-2">
                        <button className="btn-secondary-sm">View Route</button>
                        <button className="btn-secondary-sm">
                          Contact Group
                        </button>
                      </div>) : (<button className="btn-secondary-sm">
                        Contact Driver
                      </button>)}
                  </div>
                </div>))}
          ...
          <div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <ul className="divide-y divide-gray-200">
                {upcomingDeadlines.map((deadline) => (<li key={deadline.id} className="py-3 flex justify-between items-center">
...
exports.default = UnifiedFamilyDashboard;
