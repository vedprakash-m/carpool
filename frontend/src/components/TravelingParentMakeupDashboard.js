...
exports.default = TravelingParentMakeupDashboard;
const react_1 = require("react");
const lucide_react_1 = require("lucide-react");
function TravelingParentMakeupDashboard() {
    const [dashboardData, setDashboardData] = (0, react_1.useState)(null);
    const [loading, setLoading] = (0, react_1.useState)(true);
    const [error, setError] = (0, react_1.useState)(null);
    const [showNewProposal, setShowNewProposal] = (0, react_1.useState)(false);
    ...
    const fetchDashboardData = async () => {
        try {
            setLoading(true);
            const response = await fetch(`/api/traveling-parent/makeup?action=get_dashboard&userId=${userId}`);
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <lucide_react_1.AlertTriangle className={`h-8 w-8 ${dashboardData.user.makeupBalance < 0
            ? "text-red-500"
            : "text-green-500"}`}/>
                </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <lucide_react_1.Clock className="h-8 w-8 text-blue-500"/>
                </div>
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">
        ...
        {dashboardData.travelSchedule.hasUpcomingTravel && (<div className="bg-amber-50 border border-amber-200 rounded-md p-4 mb-8">
            <div className="flex">
              <div className="flex-shrink-0">
                <lucide_react_1.AlertTriangle className="h-5 w-5 text-amber-400"/>
              </div>
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-amber-700">
                  {dashboardData.travelSchedule.travelPeriods.map((period, index) => (<div key={index} className="mb-2">
        ...
        {/* Action Button */}
        <div className="mb-8">
          <button onClick={() => setShowNewProposal(true)} className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 flex items-center">
        ...
        {/* New Proposal Form */}
        {showNewProposal && (<div className="bg-white shadow rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input type="date" value={newProposal.proposedDate} onChange={(e) => setNewProposal({
                ...newProposal,
              ...
              <div>
                ...
                <input type="time" value={newProposal.proposedTime} onChange={(e) => setNewProposal({
                ...newProposal,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select value={newProposal.makeupType} onChange={(e) => setNewProposal({
                ...newProposal,
                makeupType: e.target.value,
            })} className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <div>
                ...
                <input type="number" min="1" max="5" value={newProposal.tripsToMakeup} onChange={(e) => setNewProposal({
                ...newProposal,
            ...
            <div className="mb-4">
              ...
              <textarea value={newProposal.notes} onChange={(e) => setNewProposal({ ...newProposal, notes: e.target.value })} rows={3} className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Any additional information about your makeup proposal..."/>
            </div>

            <div className="flex justify-end space-x-3">
              <button onClick={() => setShowNewProposal(false)} className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                Cancel
              </button>
              <button onClick={submitMakeupProposal} disabled={submitting} className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 disabled:opacity-50">
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          {dashboardData.makeupOptions.length === 0 ? (<div className="p-6 text-center">
              ...
              {dashboardData.makeupOptions.map((option) => (<div key={option.id} className="p-6">
                  ...
                  {option.notes && (<div className="mt-3 text-sm text-gray-600">
                      <strong>Your notes:</strong> {option.notes}
                    </div>)}

                  {option.adminNotes && (<div className="mt-3 p-3 bg-gray-50 rounded-md">
