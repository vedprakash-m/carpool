...
exports.default = FirstWeekSimulation;
const react_1 = __importStar(require("react"));
const outline_1 = require("@heroicons/react/24/outline");
function FirstWeekSimulation({ onNext, onPrevious, onComplete, }) {
    const [currentTab, setCurrentTab] = (0, react_1.useState)("assignments");
    ...
    return (<div className="space-y-6">
      <div className="text-center mb-6">
        <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
          <outline_1.StarIcon className="w-8 h-8 text-purple-600"/>
        </div>
      ...
      <div className="flex space-x-1 bg-gray-100 rounded-lg p-1">
        <button onClick={() => setCurrentTab("assignments")} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${currentTab === "assignments"
            ? "bg-white text-purple-600 shadow-sm"
            : "text-gray-600 hover:text-gray-900"}`}>
          📋 Assignment Example
        </button>
        <button onClick={() => setCurrentTab("swaps")} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${currentTab === "swaps"
            ? "bg-white text-purple-600 shadow-sm"
            : "text-gray-600 hover:text-gray-900"}`}>
      ...
      {/* Assignment Example */}
      {currentTab === "assignments" && (<div className="space-y-4">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center">
                  <outline_1.TruckIcon className="w-6 h-6 text-orange-600"/>
                </div>
                <div>
            ...
            <div className="space-y-3">
              ...
              {sampleAssignment.passengers.map((passenger, index) => (<div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
      ...
      {/* Swap Request Example */}
      {currentTab === "swaps" && (<div className="space-y-4">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                  <outline_1.ChatBubbleLeftRightIcon className="w-6 h-6 text-purple-600"/>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
        <div className="text-center">
          <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
            <outline_1.CheckCircleIcon className="w-6 h-6 text-green-600"/>
          </div>
      ...
      {/* Final Action */}
      <div className="text-center">
        <button onClick={handleComplete} className="px-8 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-blue-700 transition-all transform hover:scale-105">
