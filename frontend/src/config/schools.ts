...
export const SUPPORTED_GRADES: GradeConfig[] = [
  { id: "k", label: "Kindergarten", numericValue: 0, schoolTypes: ["elementary", "k12"] },
  { id: "1st", label: "1st Grade", numericValue: 1, schoolTypes: ["elementary", "k12"] },
  { id: "2nd", label: "2nd Grade", numericValue: 2, schoolTypes: ["elementary", "k12"] },
  { id: "3rd", label: "3rd Grade", numericValue: 3, schoolTypes: ["elementary", "k12"] },
  { id: "4th", label: "4th Grade", numericValue: 4, schoolTypes: ["elementary", "k12"] },
  { id: "5th", label: "5th Grade", numericValue: 5, schoolTypes: ["elementary", "k12"] },
  { id: "6th", label: "6th Grade", numericValue: 6, schoolTypes: ["middle", "k12"] },
  { id: "7th", label: "7th Grade", numericValue: 7, schoolTypes: ["middle", "k12"] },
  { id: "8th", label: "8th Grade", numericValue: 8, schoolTypes: ["middle", "high", "k12"] },
  { id: "9th", label: "9th Grade", numericValue: 9, schoolTypes: ["high", "k12"] },
  { id: "10th", label: "10th Grade", numericValue: 10, schoolTypes: ["high", "k12"] },
  { id: "11th", label: "11th Grade", numericValue: 11, schoolTypes: ["high", "k12"] },
  { id: "12th", label: "12th Grade", numericValue: 12, schoolTypes: ["high", "k12"] }
];
...
export const getGradesForSchool = (school: School): GradeConfig[] => {
  return SUPPORTED_GRADES.filter(grade => 
...
export const getSchoolsByType = (type: string): School[] => {
  return DEFAULT_SCHOOLS.filter(school => school.type === type && school.isActive);
};
