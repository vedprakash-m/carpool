            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500 max-w-xs"
                >
