      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-2">
            <div>
              <a
                href="https://carpool-backend-g9eqf0efgxe4hbae.eastus2-01.azurewebsites.net/api/trips/stats"
                target="_blank"
            ...
            <div>
              <a
                href="https://carpool-backend-g9eqf0efgxe4hbae.eastus2-01.azurewebsites.net/api/users/me"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline"
              >
