...
exports.setupMockAuth = setupMockAuth;
exports.clearMockAuth = clearMockAuth;
exports.getAuthState = getAuthState;
exports.waitForAuth = waitForAuth;
exports.authenticateAndNavigate = authenticateAndNavigate;
exports.setupMockAPIResponses = setupMockAPIResponses;
 ...
 */
async function setupMockAuth(page, role = "admin") {
    // Set up mock authentication for E2E tests
    await page.addInitScript((userRole) => {
        ...
        window.fetch = async (url, options) => {
            ...
            // Mock auth endpoints
            if (urlString.includes("/auth/token") ||
 ...
 * @param page - Playwright page instance
 */
async function clearMockAuth(page) {
    try {
        await page.evaluate(() => {
            try {
 ...
 */
async function authenticateAndNavigate(page, route, userType = "admin") {
 ...
 * @param page - Playwright page instance
 */
async function setupMockAPIResponses(page) {
