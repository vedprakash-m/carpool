...
async function testDatabaseConnection() {
  ...
  try {
    ...
    const databaseId = process.env.COSMOS_DB_DATABASE || "vcarpool";
    ...
    console.error(
      "  - COSMOS_DB_ENDPOINT:",
      process.env.COSMOS_DB_ENDPOINT ? "Set" : "Missing"
    );
    console.error(
      "  - COSMOS_DB_KEY:",
      process.env.COSMOS_DB_KEY ? "Set" : "Missing"
    );
    console.error(
      "  - COSMOS_DB_DATABASE:",
      process.env.COSMOS_DB_DATABASE || "Using default 'vcarpool'"
    );
