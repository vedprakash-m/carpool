...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const {
      UnifiedAuthService,
    } = require("../src/services/unified-auth.service");
    ...
    context.res = UnifiedResponseHandler.created({
      ...
      message:
        "Registration successful. Please verify your email address to complete setup.",
    });
  } catch (error) {
...
function generateAccessToken(user) {
  ...
  const JWT_SECRET = process.env.JWT_SECRET || "temp-jwt-secret-vcarpool";
